...
byte scratch; //A scratch variable to let main look run in the values
...
for ( pot = 0; pot < pots; ++pot ) {
 readonepot();
  ...
  tunerValue = (potLastRead [2] -512)*50; //produce a tuning value to be passed to a modified tonegen
}
...
potPin [0]=A1; // set the pot pin for this pot to A1
potPin [1]=A2; // set the pot pin this pot to A2
...
selected_cadence = (pot0to255[0] & B11110000)/8;
